  ...
  notes: [
    {
      ...
      text: "Strong portfolio, check the case study on TechFlow's dashboard.",
    },
    {
      author: 'Rahul (Tech Lead)',
      time: 'Apr 20, 3:00 PM',
      text: 'Reviewed GitHub. Code quality is solid, good TypeScript patterns.',
    },
  ],
  activityLog: [
        ...
        <div className="fixed inset-0 bg-black/30 z-50 flex items-center justify-center">
          <div className="bg-white rounded-xl p-6 shadow-xl max-w-sm w-full mx-4">
            ...
            <p className="text-sm text-gray-500 mb-4">
              This will move the application to Rejected. The applicant may be
              notified.
            </p>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-6 grid grid-cols-1 lg:grid-cols-3 gap-5">
        ...
        <div className="lg:col-span-2 flex flex-col gap-5">
          ...
          <div className="bg-white border border-gray-200 rounded-xl p-5 flex flex-col sm:flex-row items-start gap-4">
            <div
              className={`w-14 h-14 rounded-full flex items-center justify-center text-lg font-bold shrink-0 ${application.candidate.avatarColor}`}
            >
          ...
          <Section title="Resume & Cover Letter">
            <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg border border-gray-200 mb-4">
              <div className="flex items-center gap-3">
                <div className="w-9 h-9 bg-red-100 rounded-lg flex items-center justify-center text-red-600 text-xs font-bold">
                  PDF
                </div>
                <div>
                  <p className="text-sm font-medium text-gray-800">
                    Arjun_Menon_Resume.pdf
                  </p>
                  <p className="text-xs text-gray-400">Uploaded Apr 18, 2026</p>
                </div>
              </div>
              <div className="flex gap-2">
                <button className="text-sm px-3 py-1.5 border border-gray-300 rounded-lg text-gray-600 hover:bg-gray-100">
                  Preview
                </button>
                <button className="text-sm px-3 py-1.5 border border-gray-300 rounded-lg text-gray-600 hover:bg-gray-100">
                  Download
          ...
          <Section title="Applied For">
            <div className="space-y-2 text-sm">
              ...
              <div className="flex justify-between">
                ...
                <span className="text-gray-700">{application.job.type}</span>
              </div>
              <div className="flex justify-between">
              ...
              {application.activityLog.map((log, i) => (
                <div key={i} className="flex gap-3">
                  <div className="flex flex-col items-center">
                    ...
                    {i < application.activityLog.length - 1 && (
