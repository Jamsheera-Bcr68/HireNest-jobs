...
function AboutAndDocuments({company}:{company:CompanyProfileType|null}) {
            ...
            <div className="bg-white rounded-xl shadow-sm p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                ...
                <div>
                  ...
                  <p className="font-medium text-slate-700">{company.address.state},{company.address.country} </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-sm p-6">
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between border p-4 rounded-lg">
                  ...
                  <button onClick={()=>window.open( `${baseUrl}${company.document.file}`,"_blank")} className="text-sm bg-indigo-100 text-indigo-600 px-3 py-1 rounded-md hover:bg-indigo-200">
                    View
                  </button>
                </div>
