...
import { ApplicationFilterDto,ApplicationListDto } from '../../applications/Dtos/application.dto';
export interface IApplicationRepository extends IBaseRepository<Application> {
 ...
 getAllApplications(filter:Partial<ApplicationFilterDto>):Promise<{applications:AggregatedApplication[],totalDocs:number}>
}
