import { IRegisterUseCase } from '../../../../applications/interfaces/auth/user-register.usecase';
import { Request, Response } from 'express';
import { statusCodes } from '../../../../shared/enums/statuscodes';
import { authMessages } from '../../../../shared/constants/messages/auth.mesages';
import { IUserLoginUseCase } from '../../../../applications/interfaces/auth/user-login.usecase';
import { asyncHandler } from '../../middleweres/async-handler';
import { ISendOtpService } from '../../../../applications/interfaces/services/send-otp-service';
import { IVerifyOtpService } from '../../../../applications/interfaces/services/verify-otp.service';
import { ILogoutUsecase } from '../../../../applications/interfaces/auth/logout.usecase';

import { IloginInput } from '../../../../applications/dtos/login.dto';
